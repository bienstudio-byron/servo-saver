...
export default function FillStrategy({ stations, selectedFuelType, onChangeTrip, onOpenAlerts }: FillStrategyProps) {
        ...
        <div className="flex items-center gap-2 shrink-0">
          {onOpenAlerts && (
            <button
              ...
              className="text-[11px] text-[#fbbc04] hover:text-[#fdd835] font-semibold transition-colors cursor-pointer flex items-center gap-1"
            >
