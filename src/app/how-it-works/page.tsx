  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a]">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <h1 className="text-3xl font-bold text-white mb-3">How PetrolSaver Works</h1>
        <p className="text-[#9aa0a6] text-base mb-10 leading-relaxed">
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 space-y-3 text-sm text-[#dadce0] leading-relaxed">
            <p>
              We don&apos;t just show the cheapest station. We calculate the <strong className="text-white">true cost</strong> of
            ...
            <div className="space-y-4 mt-4">
              <div className="flex gap-3">
                ...
                <div>
                  <div className="text-white font-semibold mb-0.5">Price per litre</div>
                  <p className="text-[#9aa0a6] text-xs">The raw price at the pump, as reported by the retailer.</p>
                </div>
              </div>
              <div className="flex gap-3">
                ...
                <div>
                  <div className="text-white font-semibold mb-0.5">Detour distance</div>
                  <p className="text-[#9aa0a6] text-xs">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <div className="text-white font-semibold mb-0.5">Your fuel level</div>
                  <p className="text-[#9aa0a6] text-xs">
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 space-y-4 text-sm text-[#dadce0] leading-relaxed">
            ...
            <p>
              We then rank stations by <strong className="text-white">net savings</strong> — the amount you actually
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 space-y-4 text-sm text-[#dadce0] leading-relaxed">
            <div className="flex gap-3">
              ...
              <p className="text-[#9aa0a6] text-xs">Highest net savings after detour cost. The smartest pick — balances price vs distance.</p>
            </div>
            <div className="flex gap-3">
              <span className="text-[#4285f4] font-bold text-xs bg-[#4285f4]/10 px-2 py-1 rounded shrink-0 h-fit">CHEAPEST</span>
              <p className="text-[#9aa0a6] text-xs">Lowest raw price per litre within your range. Might be further away but has the biggest price drop.</p>
            </div>
            <div className="flex gap-3">
              <span className="text-[#9aa0a6] font-bold text-xs bg-white/5 px-2 py-1 rounded shrink-0 h-fit">CLOSEST</span>
              <p className="text-[#9aa0a6] text-xs">The nearest station to you. Shown for convenience — useful when you&apos;re low on fuel or in a rush.</p>
            </div>
            <div className="flex gap-3">
              <span className="text-red-400 font-bold text-xs bg-red-500/10 px-2 py-1 rounded shrink-0 h-fit">AVOID</span>
              <p className="text-[#9aa0a6] text-xs">The most expensive option nearby. Shown as contrast so you can see what you&apos;d waste. Not clickable.</p>
            </div>
          </div>
        </section>
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 space-y-3 text-sm text-[#dadce0] leading-relaxed">
            ...
            <div className="space-y-2 mt-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#9aa0a6] text-xs">Top 10% cheapest — great price</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#9aa0a6] text-xs">Top 10–50% — average price</span>
              </div>
              <div className="flex items-center gap-3">
                ...
                <span className="text-[#9aa0a6] text-xs">Bottom 50% — above average</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 space-y-3 text-sm text-[#dadce0] leading-relaxed">
            <p>
              When you set a destination, we filter stations to those roughly <strong className="text-white">along your route</strong> — not just
            ...
            <div className="rounded-lg bg-[#1a1a1a] p-3 font-mono text-xs">
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 text-sm text-[#dadce0] leading-relaxed">
            <div className="space-y-2">
              ...
              <div className="flex justify-between py-1.5 border-b border-white/5">
                ...
                <span className="text-white font-mono">8.5 L/100km</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-white/5">
                <span className="text-[#9aa0a6]">Road distance factor</span>
                <span className="text-white font-mono">1.35× straight line</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-white/5">
                <span className="text-[#9aa0a6]">Average city speed</span>
                <span className="text-white font-mono">35 km/h</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-white/5">
        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl border border-white/10 bg-[#242424] p-5 space-y-3 text-sm text-[#dadce0] leading-relaxed">
            <p>
              PetrolSaver is <strong className="text-white">not affiliated with any fuel retailer or brand</strong>.
